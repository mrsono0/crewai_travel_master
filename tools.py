import time
from crewai.tools import BaseTool # _run() 오버라이드 해야 한다.
...
# FlightSearchTool description 내용이 중요하다. 이 내용으로 파악
...
class FlightSearchTool(BaseTool):
    ...
    # 도시 이름을 IATA 코드로 변환하는 함수,
    # 프로젝트 배경 MZ들이 주말 짧은 여행을 즐김, api를 이용 할 수 있으나 직접 매핑
...
# HotelSearchTool description 내용이 중요하다. 이 내용으로 파악
